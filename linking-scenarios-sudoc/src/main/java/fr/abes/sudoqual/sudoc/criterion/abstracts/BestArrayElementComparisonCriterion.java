package fr.abes.sudoqual.sudoc.criterion.abstracts;
...
public abstract class BestArrayElementComparisonCriterion<TS, TT, CMP_TYPE extends Comparable<CMP_TYPE>> implements Criterion {

	private HashMap<String, ComparisonCacheEntry> cache;
	private boolean cacheEnabled;
	private CMP_TYPE maxCmpValue;
	
	protected BestArrayElementComparisonCriterion(boolean enableCache, CMP_TYPE maxCmpValue) {
