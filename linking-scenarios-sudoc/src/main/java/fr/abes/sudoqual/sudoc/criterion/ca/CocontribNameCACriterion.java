 ...
 * source: cocontributor<br/>
 * target: cocontributorSA<br/>
 * <br/>
 * 
 * Stratégie : <br/>
 * Ce critère compare chaque appellation de la liste "cocontributor (rc)" avec
 ...
 *
 */
public class CocontribNameCACriterion extends BestArrayElementComparisonCriterion<JSONObject, JSONObject, Integer> {

	private static final Logger logger = LoggerFactory.getLogger(CocontribNameCACriterion.class);
	private static final DiscretCompType COMP_TYPE = new DiscretCompTypeImpl(false, 0, true, 2, false);

	public CocontribNameCACriterion() {
		super(true, 2);
	}
