package fr.abes.sudoqual.example.criterion.rcrc;
...
/**
 * Ce critère compare l'attribut "titleWords" de la source avec l'attribut "titleWords" de la cible. <br/>
 * <br/>
 ...
 *
 */
public class TitleWordsRCRCCriterion implements Criterion {
	...
	public int compare(JSONObject source, JSONObject target) {
		...
		JSONArray targetWords = target.optJSONArray("titleWords");
